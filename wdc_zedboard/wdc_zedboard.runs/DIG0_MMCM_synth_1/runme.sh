...
HD_PWD='C:/Users/atfie/watchman-ne1/wdc_zedboard/wdc_zedboard/wdc_zedboard.runs/DIG0_MMCM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DIG0_MMCM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DIG0_MMCM.tcl
