...
HD_PWD='C:/Users/atfie/watchman-ne1/wdc_zedboard/wdc_zedboard/wdc_zedboard.runs/LCLK_MMCM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LCLK_MMCM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LCLK_MMCM.tcl
