...
HD_PWD='C:/Users/atfie/watchman-ne1/wdc_zedboard/wdc_zedboard/wdc_zedboard.runs/ADC_SELECT_IO_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_SELECT_IO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_SELECT_IO.tcl
