...
HD_PWD='C:/Users/atfie/watchman-ne1/wdc_zedboard/wdc_zedboard/wdc_zedboard.runs/SCRATCH_DPRAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SCRATCH_DPRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SCRATCH_DPRAM.tcl
