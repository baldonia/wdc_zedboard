...
#
# Generated by export_simulation on Mon Oct 05 18:00:55 -0400 2020
#
################################################################################
...
'-reset_run' switch to the './BUFFER_32K_28.sh' script.

./BUFFER_32K_28.sh -reset_run
...
./BUFFER_32K_28.sh -noclean_files

For more information on the script, please type './BUFFER_32K_28.sh -help'.
