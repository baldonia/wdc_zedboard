...
#
# Generated by export_simulation on Thu Oct 08 14:34:28 -0400 2020
#
################################################################################
...
'-reset_run' switch to the './ADC_SELECT_IO.sh' script.

./ADC_SELECT_IO.sh -reset_run
...
./ADC_SELECT_IO.sh -noclean_files

For more information on the script, please type './ADC_SELECT_IO.sh -help'.
