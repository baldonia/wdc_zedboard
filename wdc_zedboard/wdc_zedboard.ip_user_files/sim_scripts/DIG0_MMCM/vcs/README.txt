...
#
# Generated by export_simulation on Sat Oct 10 15:11:23 -0400 2020
#
################################################################################
...
'-reset_run' switch to the './DIG0_MMCM.sh' script.

./DIG0_MMCM.sh -reset_run
...
./DIG0_MMCM.sh -noclean_files

For more information on the script, please type './DIG0_MMCM.sh -help'.
