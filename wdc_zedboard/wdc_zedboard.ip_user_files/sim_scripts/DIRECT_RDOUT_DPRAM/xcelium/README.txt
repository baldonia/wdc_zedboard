...
#
# Generated by export_simulation on Tue Oct 06 15:11:16 -0400 2020
#
################################################################################
...
'-reset_run' switch to the './DIRECT_RDOUT_DPRAM.sh' script.

./DIRECT_RDOUT_DPRAM.sh -reset_run
...
./DIRECT_RDOUT_DPRAM.sh -noclean_files

For more information on the script, please type './DIRECT_RDOUT_DPRAM.sh -help'.
